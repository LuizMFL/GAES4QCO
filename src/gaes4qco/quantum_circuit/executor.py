...
class QiskitExecutor(IQuantumExecutor):
    ...
    def __init__(self, adapter: IQuantumCircuitAdapter, backend: BackendV2):
        self._adapter = adapter
        self._backend = backend

    def execute(self, circuit: Circuit, shots: int, measure: bool = True, verbose: bool = True) -> Union[Dict[str, int], Statevector]:
        ...
        if verbose: print(f"Transpiled Circuit Depth: {transpiled_circuit.depth()}")
