    ...
    def _configure_container_for_phase(self, phase_config: PhaseConfig, observer_filename: str):
        self.container.config.from_dict({
            ...
            "evolution": {
                ...
                "crossover_rate": phase_config.crossover_rate,
                "mutation_rate": phase_config.mutation_rate,
            ...
            "adaptive_rates": {
                "min_mutation_rate": phase_config.min_mutation_rate,
                "max_mutation_rate": phase_config.max_mutation_rate,
                "min_crossover_rate": phase_config.min_crossover_rate,
                "max_crossover_rate": phase_config.max_crossover_rate,
            },
            "niching": {
